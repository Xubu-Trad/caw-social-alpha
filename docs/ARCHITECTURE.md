> Alpha.11 revision: [Portable anchor packages](ANCHOR_PACKAGE.md) carry verified exact history, checkpoints and public test authority under a separately retained package fingerprint. Import returns a comparison tracker with spending and cancellation preserved. It restores no live grant and establishes no global freshness or automatic retention. All source conflicts remain open; earlier reviews below are historical.
