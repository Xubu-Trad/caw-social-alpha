> Alpha.13 revision: [Independent history reconstruction](INDEPENDENT_HISTORY_READER.md) recomputes ordinary signed lab records from fresh fixtures, including signed CAWs and unsigned fixture transfers. It imports no writer accounting or replay helpers. Inherited histories, delegation and owner grants are unsupported. This adds scoped interoperability evidence; authority, newest state, production economics and source conflicts remain unresolved. Earlier reviews below are historical.
