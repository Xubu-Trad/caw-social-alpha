...
| Independent recovery | [Controlled branch replacement and restart](PAID_REORG_RECOVERY.md) recover exact selected state through two acquired histories and two readers | Concurrent acquisition changes, independent providers, authenticated history and finality policy; [acquisition #3](https://github.com/Xubu-Trad/cawmmunity.caw-decentralized-social/issues/3), [reorg reconstruction #4](https://github.com/Xubu-Trad/cawmmunity.caw-decentralized-social/issues/4) |
