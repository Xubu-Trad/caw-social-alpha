...
| Settlement safety | [72 integrated regression cases](PAID_ACTION_REGRESSION.md) passed in isolation; broader coverage, review and delegated-wallet execution remain open | [Callback regression #2](https://github.com/Xubu-Trad/caw-social-alpha/issues/2), [wallet compatibility #6](https://github.com/Xubu-Trad/caw-social-alpha/issues/6) |
| Independent recovery | [Two collectors and two readers](PAID_HISTORY_ACQUISITION.md) agree locally; independent providers, authentication and reorg recovery open | [Independent acquisition #3](https://github.com/Xubu-Trad/caw-social-alpha/issues/3), [reorg reconstruction #4](https://github.com/Xubu-Trad/caw-social-alpha/issues/4) |
