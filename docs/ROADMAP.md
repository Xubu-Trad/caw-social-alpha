...
| Independent recovery | [Branch replacement and restart](PAID_REORG_RECOVERY.md), plus [bounded acquisition sessions](PAID_ACQUISITION_SESSION.md) checked against recorded response switches | Live changes during acquisition, independent providers, authenticated history and finality policy; [acquisition #3](https://github.com/Xubu-Trad/cawmmunity.caw-decentralized-social/issues/3), [reorg reconstruction #4](https://github.com/Xubu-Trad/cawmmunity.caw-decentralized-social/issues/4) |
